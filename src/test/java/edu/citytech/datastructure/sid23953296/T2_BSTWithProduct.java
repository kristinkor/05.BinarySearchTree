...
public class T2_BSTWithProduct {
    ...
    @Test
    @DisplayName("Searching by Product with Consumer")
    void getBasicSearchEngine2() {
        List<Product> list = new ArrayList<>();
        var bst = new BinarySearchTree<Product>();
        bst.insert(products);
        // list:: add is calling the version of find with Consumer
        //consumer will execute the add method
    ...
    @Test
    @DisplayName("Searching by Product with Consumer, and Custom SearchEngine")
